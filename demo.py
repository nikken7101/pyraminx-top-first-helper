...
def demo():
    ...
    v_solutions_texts = [(" ".join(turns) if len(turns) != 0 else "Solved!") + " ({} face)".format(face)
                         for turns, face, method in solutions if method == "v-first"]
    return template("demo",
